...
function par_create() {
  ...
  assoc_file="liveJournal-npa${npa}sa${sa}isa${isa}.assoc"
  node_file="liveJournal-${dataset}-tpch-npa${npa}sa${sa}isa${isa}.node"
  ln -sf liveJournal.assoc ${assoc_file}
  ln -sf liveJournal-${dataset}-tpch.node ${node_file}
