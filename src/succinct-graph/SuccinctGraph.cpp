...
std::vector<SuccinctGraph::AssocResult> SuccinctGraph::assoc_get(
    ...
    while (l + 1 < r) {
        ...
        ts = SuccinctGraphSerde::decode_int64(timestamp);
    ...
    printf("range left: %d, range right: %d, cnt: %d\n", range_left, range_right, cnt);
