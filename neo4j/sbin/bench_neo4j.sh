...
TOTAL_MEM=249856 # r3.8xlarge, 244GB
# TOTAL_MEM=15043 # c4.2xlarge, 15GB
...
# Consider only two datasets: twitter2010, orkut
if [[ "$DATASET" == "twitter2010-40attr16each"* ]]; then
  ...
  echo "Initialize parameters for new dataset."
  exit 1
fi
