...
typedef struct _GraphQueryService_get_edge_update_ptrs_args__isset {
  _GraphQueryService_get_edge_update_ptrs_args__isset() : src(false), atype(false) {}
  bool src;
  bool atype;
} _GraphQueryService_get_edge_update_ptrs_args__isset;

class GraphQueryService_get_edge_update_ptrs_args {
 public:

  GraphQueryService_get_edge_update_ptrs_args() : src(0), atype(0) {
  }

  virtual ~GraphQueryService_get_edge_update_ptrs_args() throw() {}

  int64_t src;
  int64_t atype;

  _GraphQueryService_get_edge_update_ptrs_args__isset __isset;
  ...
  bool operator == (const GraphQueryService_get_edge_update_ptrs_args & rhs) const
  {
    if (!(src == rhs.src))
      return false;
    if (!(atype == rhs.atype))
  ...
  bool operator < (const GraphQueryService_get_edge_update_ptrs_args & ) const;
...
class GraphQueryService_get_edge_update_ptrs_pargs {
 public:


  virtual ~GraphQueryService_get_edge_update_ptrs_pargs() throw() {}
...
typedef struct _GraphQueryService_get_edge_update_ptrs_result__isset {
  _GraphQueryService_get_edge_update_ptrs_result__isset() : success(false) {}
  bool success;
} _GraphQueryService_get_edge_update_ptrs_result__isset;

class GraphQueryService_get_edge_update_ptrs_result {
 public:

  GraphQueryService_get_edge_update_ptrs_result() {
  }

  virtual ~GraphQueryService_get_edge_update_ptrs_result() throw() {}

  std::vector<ThriftEdgeUpdatePtr>  success;

  _GraphQueryService_get_edge_update_ptrs_result__isset __isset;

  void __set_success(const std::vector<ThriftEdgeUpdatePtr> & val) {
    success = val;
  }

  bool operator == (const GraphQueryService_get_edge_update_ptrs_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const GraphQueryService_get_edge_update_ptrs_result & ) const;
...
typedef struct _GraphQueryService_get_edge_update_ptrs_presult__isset {
  _GraphQueryService_get_edge_update_ptrs_presult__isset() : success(false) {}
  bool success;
} _GraphQueryService_get_edge_update_ptrs_presult__isset;

class GraphQueryService_get_edge_update_ptrs_presult {
 public:


  virtual ~GraphQueryService_get_edge_update_ptrs_presult() throw() {}

  std::vector<ThriftEdgeUpdatePtr> * success;

  _GraphQueryService_get_edge_update_ptrs_presult__isset __isset;
