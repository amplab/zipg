...
class GraphQueryAggregatorServiceConcurrentClient : virtual public GraphQueryAggregatorServiceIf {
 ...
 public:
  ...
  int32_t init_local_shards();
  int32_t send_init_local_shards();
  int32_t recv_init_local_shards(const int32_t seqid);
  int32_t local_data_init();
  int32_t send_local_data_init();
  int32_t recv_local_data_init(const int32_t seqid);
  int32_t connect_to_aggregators();
  int32_t send_connect_to_aggregators();
  int32_t recv_connect_to_aggregators(const int32_t seqid);
  int32_t connect_to_local_shards();
  int32_t send_connect_to_local_shards();
  int32_t recv_connect_to_local_shards(const int32_t seqid);
  void shutdown();
  int32_t send_shutdown();
  void recv_shutdown(const int32_t seqid);
  void disconnect_from_local_shards();
  int32_t send_disconnect_from_local_shards();
  void recv_disconnect_from_local_shards(const int32_t seqid);
  void disconnect_from_aggregators();
  int32_t send_disconnect_from_aggregators();
  void recv_disconnect_from_aggregators(const int32_t seqid);
  int32_t backfill_edge_updates();
  int32_t send_backfill_edge_updates();
  int32_t recv_backfill_edge_updates(const int32_t seqid);
  void record_edge_updates(const int32_t next_shard, const int32_t local_shard, const std::vector<ThriftSrcAtype> & updates);
  ...
  void assoc_range_batched(std::vector<std::vector<ThriftAssoc> > & _return, const std::vector<int64_t> & src, const std::vector<int64_t> & atype, const std::vector<int32_t> & off, const std::vector<int32_t> & len);
  int32_t send_assoc_range_batched(const std::vector<int64_t> & src, const std::vector<int64_t> & atype, const std::vector<int32_t> & off, const std::vector<int32_t> & len);
  void recv_assoc_range_batched(std::vector<std::vector<ThriftAssoc> > & _return, const int32_t seqid);
  void assoc_range_local(std::vector<ThriftAssoc> & _return, const int32_t shardId, const int64_t src, const int64_t atype, const int32_t off, const int32_t len);
  ...
  void assoc_count_batched(std::vector<int64_t> & _return, const std::vector<int64_t> & src, const std::vector<int64_t> & atype);
  int32_t send_assoc_count_batched(const std::vector<int64_t> & src, const std::vector<int64_t> & atype);
  void recv_assoc_count_batched(std::vector<int64_t> & _return, const int32_t seqid);
  int64_t assoc_count_local(const int32_t shardId, const int64_t src, const int64_t atype);
  ...
  void assoc_get_batched(std::vector<std::vector<ThriftAssoc> > & _return, const std::vector<int64_t> & src, const std::vector<int64_t> & atype, const std::vector<std::set<int64_t> > & dstIdSet, const std::vector<int64_t> & tLow, const std::vector<int64_t> & tHigh);
  int32_t send_assoc_get_batched(const std::vector<int64_t> & src, const std::vector<int64_t> & atype, const std::vector<std::set<int64_t> > & dstIdSet, const std::vector<int64_t> & tLow, const std::vector<int64_t> & tHigh);
  void recv_assoc_get_batched(std::vector<std::vector<ThriftAssoc> > & _return, const int32_t seqid);
  void assoc_get_local(std::vector<ThriftAssoc> & _return, const int32_t shardId, const int64_t src, const int64_t atype, const std::set<int64_t> & dstIdSet, const int64_t tLow, const int64_t tHigh);
  ...
  void obj_get_batched(std::vector<std::vector<std::string> > & _return, const std::vector<int64_t> & nodeId);
  int32_t send_obj_get_batched(const std::vector<int64_t> & nodeId);
  void recv_obj_get_batched(std::vector<std::vector<std::string> > & _return, const int32_t seqid);
  void obj_get_local(std::vector<std::string> & _return, const int32_t shardId, const int64_t nodeId);
  ...
  void assoc_time_range_batched(std::vector<std::vector<ThriftAssoc> > & _return, const std::vector<int64_t> & src, const std::vector<int64_t> & atype, const std::vector<int64_t> & tLow, const std::vector<int64_t> & tHigh, const std::vector<int32_t> & limit);
  int32_t send_assoc_time_range_batched(const std::vector<int64_t> & src, const std::vector<int64_t> & atype, const std::vector<int64_t> & tLow, const std::vector<int64_t> & tHigh, const std::vector<int32_t> & limit);
  void recv_assoc_time_range_batched(std::vector<std::vector<ThriftAssoc> > & _return, const int32_t seqid);
  void assoc_time_range_local(std::vector<ThriftAssoc> & _return, const int32_t shardId, const int64_t src, const int64_t atype, const int64_t tLow, const int64_t tHigh, const int32_t limit);
