...
class connect_to_aggregators_args:
...
class connect_to_aggregators_result:
  """
  Attributes:
   - success
  """
...
class disconnect_from_aggregators_args:
...
class disconnect_from_aggregators_result:
...
class record_edge_updates_args:
  """
  Attributes:
   - next_shard
   - local_shard
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'updates', (TType.STRUCT,(ThriftSrcAtype, ThriftSrcAtype.thrift_spec)), None, ), # 3
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.next_shard)
    value = (value * 31) ^ hash(self.local_shard)
...
class record_edge_updates_result:
...
class record_node_append_result:
...
class get_attribute_args:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.attrId)
    return value
...
class get_attribute_local_args:
  """
  Attributes:
   - shardId
   - nodeId
...
class get_attribute_local_result:
  """
  Attributes:
   - success
  """
...
class get_neighbors_local_args:
  """
  Attributes:
   - shardId
   - nodeId
...
class get_neighbors_local_result:
  """
  Attributes:
   - success
  """
...
class get_neighbors_atype_args:
  """
  Attributes:
   - nodeId
   - atype
...
class get_neighbors_atype_result:
  """
  Attributes:
   - success
  """
...
class get_neighbors_atype_local_args:
  """
  Attributes:
   - shardId
   - nodeId
...
class get_neighbors_atype_local_result:
  """
  Attributes:
   - success
  """
...
class get_neighbors_attr_args:
  ...
  thrift_spec = (
    ...
    (1, TType.I64, 'nodeId', None, None, ), # 1
    (2, TType.I32, 'attrId', None, None, ), # 2
    (3, TType.STRING, 'attrKey', None, None, ), # 3
  )
  ...
  def write(self, oprot):
    ...
    if self.attrKey is not None:
      ...
      oprot.writeString(self.attrKey)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.nodeId)
    value = (value * 31) ^ hash(self.attrId)
    value = (value * 31) ^ hash(self.attrKey)
    return value
...
class get_neighbors_attr_result:
  """
  Attributes:
   - success
  """
...
class get_neighbors_attr_local_args:
  """
  Attributes:
   - shardId
   - nodeId
  ...
  thrift_spec = (
    ...
    (2, TType.I64, 'nodeId', None, None, ), # 2
    (3, TType.I32, 'attrId', None, None, ), # 3
    (4, TType.STRING, 'attrKey', None, None, ), # 4
  )
...
class get_neighbors_attr_local_result:
  """
  Attributes:
   - success
  """
...
class get_nodes_args:
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'attrKey', None, None, ), # 2
  )
...
class get_nodes2_args:
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'attrKey1', None, None, ), # 2
    (3, TType.I32, 'attrId2', None, None, ), # 3
    (4, TType.STRING, 'attrKey2', None, None, ), # 4
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.attrKey1 = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.I32:
        ...
        if ftype == TType.STRING:
          self.attrKey2 = iprot.readString()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.attrKey1 is not None:
      ...
      oprot.writeString(self.attrKey1)
      oprot.writeFieldEnd()
    ...
    if self.attrKey2 is not None:
      ...
      oprot.writeString(self.attrKey2)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.attrId1)
    value = (value * 31) ^ hash(self.attrKey1)
    value = (value * 31) ^ hash(self.attrId2)
    value = (value * 31) ^ hash(self.attrKey2)
    return value
...
class filter_nodes_local_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'nodeIds', (TType.I64,None), None, ), # 1
    (2, TType.I32, 'attrId', None, None, ), # 2
    (3, TType.STRING, 'attrKey', None, None, ), # 3
  )
...
class filter_nodes_local_result:
  """
  Attributes:
   - success
  """
...
class get_edge_attrs_local_args:
  """
  Attributes:
   - shardId
   - nodeId
...
class get_edge_attrs_local_result:
  """
  Attributes:
   - success
  """
...
class assoc_range_result:
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(ThriftAssoc, ThriftAssoc.thrift_spec)), None, ), # 0
  )
...
class assoc_range_local_result:
  """
  Attributes:
   - success
  """
...
class assoc_count_local_result:
  """
  Attributes:
   - success
  """
...
class assoc_get_args:
  ...
  thrift_spec = (
    ...
    (1, TType.I64, 'src', None, None, ), # 1
    (2, TType.I64, 'atype', None, None, ), # 2
    (3, TType.SET, 'dstIdSet', (TType.I64,None), None, ), # 3
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.src)
    value = (value * 31) ^ hash(self.atype)
    value = (value * 31) ^ hash(self.dstIdSet)
    value = (value * 31) ^ hash(self.tLow)
    value = (value * 31) ^ hash(self.tHigh)
    return value
...
class assoc_get_local_args:
  ...
  thrift_spec = (
    ...
    (2, TType.I64, 'src', None, None, ), # 2
    (3, TType.I64, 'atype', None, None, ), # 3
    (4, TType.SET, 'dstIdSet', (TType.I64,None), None, ), # 4
...
class assoc_time_range_local_args:
  """
  Attributes:
   - shardId
   - src
...
class assoc_time_range_local_result:
  """
  Attributes:
   - success
  """
...
class getNodeLocal_args:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.shard_id)
    value = (value * 31) ^ hash(self.id)
    return value
...
class getLink_args:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.id1)
    value = (value * 31) ^ hash(self.link_type)
...
class getFilteredLinkList_args:
  """
  Attributes:
   - id1
   - link_type
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.id1)
    value = (value * 31) ^ hash(self.link_type)
    value = (value * 31) ^ hash(self.min_timestamp)
    value = (value * 31) ^ hash(self.max_timestamp)
...
class getFilteredLinkList_result:
  """
  Attributes:
   - success
  """
...
class getFilteredLinkListLocal_args:
  """
  Attributes:
   - shard_id
   - id1
...
class getFilteredLinkListLocal_result:
  """
  Attributes:
   - success
  """
