...
do
    ...
    ${BIN_DIR}/create neighbor-node-queries ${SUCCINCT_DIR}/${num_nodes}.graph ${warmup_neighbor_node} ${measure_neighbor_node} ${QUERY_DIR}/neighbor_node_warmup_${num_nodes}.txt ${QUERY_DIR}/neighbor_node_query_${num_nodes}.txt
done
